...
reference_dir = r"C:\Users\PC\Downloads\VSCODE FILES\PYTHON\TESTING\14-AudioImplementation\Recordings\REFERENCES"
samples_dir = r"C:\Users\PC\Downloads\VSCODE FILES\PYTHON\TESTING\14-AudioImplementation\Recordings\SAMPLES"
...
def read_files():
    """Reads aloud the classification of given .edf files."""
    while True:
        file_names = input("Name the file(s) that you want to be read (comma-separated) or type 'back' to return, 'stop' to exit: ").strip().lower()
...
def classify_and_train():
    while True:
        ...
        if mode == "debugging":
            while True:
                print("=================================================================")
                new_file_name = input("Enter the name of the new EDF file ('stop', 'all', 'new', 'add', 'reset', 'remove', 'back'): ")
            ...
            print("Invalid mode. Please enter 'Reading' or 'Debugging'.")
