...
hello_file = os.path.join(reference_dir, "HELLO - REFERENCE_INSIGHT2_255587_2024.12.21T23.07.23+08.00.edf")
please_file = os.path.join(reference_dir, "PLEASE - REFERENCE_INSIGHT2_255587_2024.12.21T23.33.20+08.00.edf")
sorry_file = os.path.join(reference_dir, "SORRY - REFENRECE_INSIGHT2_255587_2024.12.21T23.38.23+08.00.edf")
thanks_file = os.path.join(reference_dir, "THANKS - REFERENCE_INSIGHT2_255587_2024.12.21T23.43.27+08.00.edf")
...
try:
    ...
    reference_features["hello"] = load_edf_features(hello_file)
    reference_features["please"] = load_edf_features(please_file)
    reference_features["sorry"] = load_edf_features(sorry_file)
    reference_features["thanks"] = load_edf_features(thanks_file)
except FileNotFoundError as e:
    print(e)
    exit()
